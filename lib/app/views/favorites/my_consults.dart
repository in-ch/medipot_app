...
class MyConsults extends StatefulWidget {
  const MyConsults({Key? key}) : super(key: key);

  @override
  State<MyConsults> createState() => _MyLocationsState();
}

class _MyLocationsState extends State<MyConsults> {
  final PagingController<int, Consult> _pagingController =
